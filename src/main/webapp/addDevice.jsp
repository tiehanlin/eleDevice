...
<body>
	<header>
		...
		<a id="goIndex" href="/page/real"> 数据<br />总览 <br /> <span
			style="color: rgb(85, 251, 255);">→</span>
		</a>
		<h1 style="float: left; font-size: 30px;">智慧电梯维保服务平台</h1>
		<div class="headerDiv2" style="float: left">
			<span id="timetext" style="position: absolute; bottom: -5px;">
				系统时间<span id="times"></span>
			</span>
			<div id="front">
				设备<br /> 管理 <br /> <span style="color: rgb(85, 251, 255);">→</span>
			</div>
			<ul id="frontUl" style="">
	...
	<div class="bodyer">
		<div class="row topRow" style="position: relative;">
			...
			<div class="col-xs-8" id="deviceMap" style="margin-top: 5px;">
				11</div>
			<div class="col-xs-4 ">
				<div id="deviceError" class="row"
					style="overflow: scroll; padding-top: 40px;">
					<h2>添加一个新设备</h2>
					<form class="form-horizontal">
						<div class="form-group">
							<label for="deviceName" class="col-sm-2 control-label"
								style="color: white">设备名称</label>
							<div class="col-sm-10">
								<input type="email" class="form-control" id="deviceName"
									placeholder="设备名称">
							</div>
						</div>
						<div class="form-group">
							<label for="deviceType" class="col-sm-2 control-label"
								style="color: white">设备类型</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="deviceLocation" class="col-sm-2 control-label"
								style="color: white">设备位置</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="deviceLocationLng"
									placeholder="经度" style="width: 45%; display: inline-block;"
									disabled="disabled"> <input type="text"
									class="form-control" id="deviceLocationLat" placeholder="纬度"
									style="width: 45%; display: inline-block;" disabled="disabled">
							</div>
						</div>
						<button type="button" id="addDevice"
							class="btn btn-info btn-lg center-block"
							style="margin-top: 40px;">添加设备</button>
					</form>
				</div>
			</div>
	...
	<script type="text/javascript" src="https://webapi.amap.com/maps?v=1.4.4&key=ec94a5c7fb1acf789b258c99ef83af38&plugin=AMap.Geocoder"></script>
